          ...
          <div className="relative group">
            ...
            <div className=" transition-[all]">
              ...
              <div className="absolute w-full h-full bottom-[8px] left-[16px]  pl-[1em] pr-[1em] flex flex-col justify-end text-white">
                {/* content */}
                <p className="text-lg">
                  Dear friend, We value your support and your insights.We offer
                  you a platfrom where you can buy directly from farmers, invest
                  in farming, connect and communicate with everyone you want.
                  What's more you can post your thoughts and everyone can see
                  them.
                </p>
              </div>
            </div>
